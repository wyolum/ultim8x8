...
#define HOSTNAME "Take A Number" ///< Hostname. The setup function adds the Chip ID at the end.
...
void setup() {
  ...
  webServer.on("/take_a_number", HTTP_POST, []() {
    String value = webServer.arg("value");
    take_a_number = value.toInt();
    sendInt(take_a_number);
  });
