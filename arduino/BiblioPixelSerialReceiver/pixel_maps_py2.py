...
## build 16x24 array map
ultim16x24 = MultiMapBuilder()
ultim16x24.addRow(mapGen(8, 24, serpentine=True,
                  rotation=MatrixRotation.ROTATE_90,
                  vert_flip=False))
ultim16x24.addRow(mapGen(8, 24, serpentine=True,
...
def create_map_h():
    ...
    for mmb in [ultim8x8, ultim8x24, ultim16x24, ultim24x24, ultim8x72, ultim16x56]:
        m = mmb.map
        w = len(m[0])
        h = len(m)
