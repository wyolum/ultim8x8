...
void displayTime(uint32_t tm){
  ...
  digit(39, ss / 10);
  digit(48, ss % 10);
  setPixelMask( 4, 17, true);
  setPixelMask( 5, 17, true);
  setPixelMask(10, 17, true);
  setPixelMask(11, 17, true);
  setPixelMask( 4, 17 + 20, true);
  setPixelMask( 5, 17 + 20, true);
  setPixelMask(10, 17 + 20, true);
  setPixelMask(11, 17 + 20, true);
}
